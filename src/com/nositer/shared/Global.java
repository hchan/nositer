...
public class Global {
	...
	public static final String USERIMAGEDIRTEMPLATE = USERROOTDIR + "/{0}/image";
	public static final String USERPUBLICIMAGEDIRTEMPLATE = USERIMAGEDIRTEMPLATE + "/public";
	public static final String USERPRIVATEIMAGEDIRTEMPLATE = USERIMAGEDIRTEMPLATE + "/private";
