package com.nositer.client.searchforblogs;
...
public class SearchForBlogsContainer extends LayoutContainer implements Resizable {
	...
	private static SearchForBlogsContainer instance;
	...
	public static SearchForBlogsContainer getInstance() {
		return instance;
	}

	public static void setInstance(SearchForBlogsContainer instance) {
		SearchForBlogsContainer.instance = instance;
	}

	public SearchForBlogsContainer() {
		init();
	}
