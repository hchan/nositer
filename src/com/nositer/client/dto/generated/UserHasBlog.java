 ...
 */
public class UserHasBlog implements java.io.Serializable, IsSerializable,
	...
	public static final String TABLENAME = "nositer.user_has_blog";
	...
	public UserHasBlog clone() {

		UserHasBlog retval = new UserHasBlog();
		if (id != null) {
	...
	public enum Column {
		id, blogid, userid, createdtime, modifiedtime,
	}
